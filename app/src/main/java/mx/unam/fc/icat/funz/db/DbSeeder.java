...
public class DbSeeder extends RoomDatabase.Callback {
    ...
    private static Module buildModule(int id, String name, String subtitle, String desc, int order, boolean unlocked, int count, String it1, String ix1, String it2, String ix2, String eq, String[] steps) {
        Module m = new Module();
        m.id = id; m.name = name; m.subtitle = subtitle; m.description = desc; m.orderIndex = order;
        m.unlocked = unlocked; m.exerciseCount = count; m.infoTitle1 = it1; m.infoText1 = ix1;
        m.infoTitle2 = it2; m.infoText2 = ix2; m.exampleEquation = eq; m.exampleSteps = toJson(steps);
        return m;
    }
