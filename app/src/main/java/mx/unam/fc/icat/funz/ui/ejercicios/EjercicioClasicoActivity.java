...
/**
 * EjercicioClasicoActivity — Pantalla D2: Ejercicio 2/3 (Método
 * Clásico/Baldor).
 *
...
public class EjercicioClasicoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (AppState.getInstance().isDarkTheme())
    ...
    private void showResultDialog(boolean correct, boolean withHint) {
        ...
        if (correct) {
            ...
            b.setTitle("🎉 ¡Correcto!")
                    ...
                    .setCancelable(false);
            if (withHint)
                b.setNeutralButton("Sin pista (+50)", (d, w) -> {
                    etAnswer.setText("");
                    vm.retryWithoutHint();
                });
        } else {
    ...
    private void setupHamburger() {
        findViewById(R.id.btn_hamburger).setOnClickListener(v -> drawerMenu.setVisibility(
